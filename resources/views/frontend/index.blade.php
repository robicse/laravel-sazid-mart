                                            ...
                                            <div class="item item-carousel">
                                                <div class="products">
                                                    ...
                                                    <div class="product">
                                                        <div class="product-image">
                                                            <div class="image">
                                                                <a href="{{route('product-details',$newProduct->slug)}}"><img  src="{{url($newProduct->thumbnail_img)}}" alt="" width="189" height="206"></a>
                                                            </div><!-- /.image -->
                                                        ...
                                                        <div class="product-info text-left">
                                                            <h3 class="name"><a href="{{route('product-details',$newProduct->slug)}}">{{$newProduct->name}}</a></h3>
                                                            <div class="rating rateit-small"></div>
                                                            <div class="description"></div>

                                                            <div class="product-price">
				<span class="price">
					৳ {{$newProduct->purchase_price}}			</span>
                                                                <span class="price-before-discount">৳ {{$newProduct->unit_price}}</span>
                                ...
                                <div class="item item-carousel">
                                    <div class="products">
                                        ...
                                        <div class="product">
                                            <div class="product-image">
                                                <div class="image">
                                                    <a href="{{route('product-details',$featuredProduct->slug)}}"><img  src="{{url($featuredProduct->thumbnail_img)}}" alt="" width="189" height="206"></a>
                                                </div><!-- /.image -->
                                            ...
                                            <div class="product-info text-left">
                                                <h3 class="name"><a href="{{route('product-details',$featuredProduct->slug)}}">{{$featuredProduct->name}}</a></h3>
                                                <div class="rating rateit-small"></div>
                                                <div class="description"></div>

                                                <div class="product-price">
				<span class="price">
					৳ {{$featuredProduct->purchase_price}}			</span>
                                                    <span class="price-before-discount">৳ {{$featuredProduct->unit_price}}</span>
                                            ...
                                            <div class="product-micro">
                                                <div class="row product-micro-row">
                                                        ...
                                                        <div class="product-image">
                                                            <div class="image">
                                                                <a href="{{route('product-details',$bestSellerProduct->slug)}}">
                                                                    <img src="{{url($bestSellerProduct->thumbnail_img)}}" alt="">
                                                                </a>
                                                            </div><!-- /.image -->
                                                    ...
                                                    <div class="col2 col-xs-7">
                                                        <div class="product-info">
                                                            <h3 class="name"><a href="{{route('product-details',$bestSellerProduct->slug)}}">{{$bestSellerProduct->name}}</a></h3>
                                                            <div class="rating rateit-small"></div>
                                                            <div class="product-price">
				<span class="price">
					৳ {{$bestSellerProduct->purchase_price}}			</span>
...
{{--                                        </div>--}}
                    ...
                    <section class="section latest-blog outer-bottom-vs wow fadeInUp">
                        <h3 class="section-title">latest blog post</h3>
